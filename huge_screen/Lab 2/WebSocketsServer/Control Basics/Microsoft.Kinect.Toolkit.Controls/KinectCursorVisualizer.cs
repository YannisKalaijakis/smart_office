    ...
    public class KinectCursorVisualizer : Canvas
    {
        ...
        private void OnHandPointersUpdated(object sender, EventArgs args)
        {
            ...
            foreach (HandPointer pointer in this.pointerCursorMap.Keys)
            {
                ...
                Canvas.SetLeft(cursor, CurrentXPosition = cursorCanvasPosition.X - deltaX);
                Canvas.SetTop(cursor, CurrentYPosition = cursorCanvasPosition.Y - deltaY);
        ...
        public static double CurrentXPosition  { get; set; }
        public static double CurrentYPosition  { get; set; }
        public static double CurrentPressLevel { get; set; }
    }
}
